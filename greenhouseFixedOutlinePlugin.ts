...
export function greenhouseFixedOutline(): Plugin {
  return {
    ...
    transform(code, id) {
      ...
      const newBlock = `    this.add.rectangle(WIDTH - 122, 1005, 220, 54, 0x0f766e, 0)\n      .setStrokeStyle(3, 0xa7f3e6, 0.9)\n      .setDepth(31);\n    const greenhouseButton = this.makeButton(WIDTH - 122, 1005, 208, 46, \`🌱 SERRE  ·  💧 \${this.wateringCans}\`, 0x0f766e, () => this.showPermanentGreenhouse())\n      .setDepth(32);\n    greenhouseButton.on("pointerover", () => greenhouseButton.setScale(1.02));\n    greenhouseButton.on("pointerout", () => greenhouseButton.setScale(1));`;
