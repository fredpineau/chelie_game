...
export function realisticEnemyVisuals(): Plugin {
  return {
    ...
    transform(code, id) {
      ...
      // Vite peut présenter des modules proxy rattachés à index.html pendant le build.
      // On ne doit jamais faire échouer le build si ce n'est pas le vrai source TS.
      ...
      // Suppression réelle des racines avant compilation TypeScript.
