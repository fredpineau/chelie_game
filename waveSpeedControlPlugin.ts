...
export function waveSpeedControl(): Plugin {
  return {
    ...
    transform(code, id) {
      ...
      const hudReplacement = `    const speedButton = this.add.container(WIDTH - 120, HEIGHT - 322).setDepth(22);\n    const speedGlow = this.add.circle(0, 0, 38, 0xf7df45, 0.2)\n      .setStrokeStyle(3, 0xf7df45, 0.95);\n    const speedBackground = this.add.circle(0, 0, 30, 0x176d78, 1)\n      .setStrokeStyle(2, 0xa8edf2, 0.95);\n    const speedArrowLeft = this.add.triangle(-7, 0, -8, -12, 10, 0, -8, 12, 0xf8ffff, 1);\n    const speedArrowRight = this.add.triangle(7, 0, -8, -12, 10, 0, -8, 12, 0xf8ffff, 1);\n    this.waveSpeedButtonText = this.add.text(0, 43, "", {\n      fontFamily: "Arial", fontSize: "13px", color: "#f8ffff", fontStyle: "bold",\n      stroke: "#102d35", strokeThickness: 3,\n    }).setOrigin(0.5);\n    speedButton.add([speedGlow, speedBackground, speedArrowLeft, speedArrowRight, this.waveSpeedButtonText]);\n    speedButton.setSize(82, 92).setInteractive({ useHandCursor: true });\n    speedButton.on("pointerover", () => speedButton.setScale(1.05));\n    speedButton.on("pointerout", () => speedButton.setScale(1));\n    speedButton.on("pointerdown", () => {\n      this.waveSpeedMode = (this.waveSpeedMode + 1) % 3;\n      const multipliers = [1, 1.5, 2];\n      const labels = ["", "×1", "×2"];\n      this.waveSpeedMultiplier = multipliers[this.waveSpeedMode];\n      this.waveSpeedButtonText?.setText(labels[this.waveSpeedMode]);\n      this.time.timeScale = this.waveSpeedMultiplier;\n    });\n\n    const pauseButton = this.add.container(WIDTH - 83, HEIGHT - 42);`;
