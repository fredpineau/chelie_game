...
/**
 * Keeps enemy rerouting safe after plant placement/removal.
 * Movement is validated against plant rectangles before it is applied so a
 * large mobile frame delta cannot tunnel an enemy through a newly placed plant.
 */
